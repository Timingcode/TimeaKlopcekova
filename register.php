...
input[type="submit"] {
    width: 100%;
    background-color: #007bff; /* Zmena farby na modrú pre univerzálnejší vzhľad */
    color: white;
    padding: 16px 20px; /* Viac paddingu pre výraznejšie tlačidlo */
    margin: 10px 0; /* Zväčšená medzera nad tlačidlom */
    border: none;
    border-radius: 6px; /* Zväčšené zaoblenie */
    cursor: pointer;
}

input[type="submit"]:hover {
    background-color: #0056b3; /* Tmavšia modrá pri najetí myšou */
}

.error-message {
    color: #d32f2f; /* Tmavšia červená pre error správy */
    margin-top: 15px; /* Zväčšená medzera nad správou */
    text-align: center;
}

.form-container p {
    text-align: center;
    margin-top: 15px; /* Zväčšená medzera nad odstavcom */
}

.form-container a {
    text-decoration: none;
    color: #28a745; /* Zmena farby odkazu na zelenú pre lepšiu viditeľnosť */
}
